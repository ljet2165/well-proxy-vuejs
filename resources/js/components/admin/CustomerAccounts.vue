<template>
  <div class="profile">
    <section class="container-fluid profile-header-section pl-0 pr-0">
      <!-- navigation start -->
      <Header></Header>
      <!-- navigation end -->
    </section>
    ...
    <main>
      <div class="container-fluid">
        <div class="row mt-4">
          ...
          <CustomerAccountsComponent></CustomerAccountsComponent>
...
.profile-header-section .contact-container {
  padding: 1rem 1.5rem;
  padding-top: 0.8rem;
...
import CustomerAccountsComponent from "./CustomerAccountsComponent";
